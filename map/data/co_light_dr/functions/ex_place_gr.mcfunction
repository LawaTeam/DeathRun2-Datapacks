...
execute as @a[x=-39,y=23,z=-28,dx=1,dz=3,dy=1] at @s if score point_2 Point_m3 matches 0..200 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-41,y=23,z=-11,dx=3,dz=3,dy=1] at @s if score point_3 Point_m3 matches 0..160 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-41,y=23,z=0,dx=3,dz=3,dy=1] at @s if score point_4 Point_m3 matches 0..250 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-39,y=24,z=13,dx=1,dz=3,dy=1] at @s if score point_5 Point_m3 matches 0..150 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-40,y=23,z=29,dx=2,dz=3,dy=1] at @s if score point_6 Point_m3 matches 0..150 run function co_light_dr:gz_sz/map_3/red
...
#Point_7
execute as @a[x=-40,y=23,z=54,dx=2,dz=3,dy=1] at @s unless score point_7 Point_m3 matches -220.. run function co_light_dr:gz_sz/map_3/green/mp_7
execute as @a[x=-40,y=23,z=54,dx=2,dz=3,dy=1] at @s if score point_7 Point_m3 matches 0..120 run function co_light_dr:gz_sz/map_3/red
execute as @a[x=-40,y=23,z=54,dx=2,dz=3,dy=1] at @s if score point_7 Point_m3 matches -220..-1 run function co_light_dr:gz_sz/map_3/yellow
#Point_8
...
execute as @a[x=-40,y=23,z=67,dx=2,dz=3,dy=1] at @s if score point_8 Point_m3 matches 0..180 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-40,y=23,z=82,dx=2,dz=3,dy=1] at @s if score point_9 Point_m3 matches 0..180 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-67,y=23,z=98,dx=4,dz=2,dy=1] at @s if score point_10 Point_m3 matches 0..150 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-81,y=23,z=98,dx=3,dz=2,dy=1] at @s if score point_11 Point_m3 matches 0..80 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-90,y=23,z=109,dx=2,dz=3,dy=1] at @s if score point_12 Point_m3 matches 0..90 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-90,y=23,z=127,dx=2,dz=2,dy=1] at @s if score point_13 Point_m3 matches 0..135 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-90,y=23,z=131,dx=2,dz=2,dy=1] at @s if score point_14 Point_m3 matches 0..150 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-90,y=23,z=137,dx=2,dz=2,dy=1] at @s if score point_15 Point_m3 matches 0..180 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-69,y=23,z=147,dx=3,dz=2,dy=1] at @s if score point_16 Point_m3 matches 0..150 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-56,y=23,z=146,dx=3,dz=2,dy=1] at @s if score point_17 Point_m3 matches 0..150 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-38,y=23,z=131,dx=2,dz=3,dy=1] at @s if score point_18 Point_m3 matches 0..150 run function co_light_dr:gz_sz/map_3/red
...
execute as @a[x=-38,y=23,z=120,dx=2,dz=3,dy=1] at @s if score point_19 Point_m3 matches 0..150 run function co_light_dr:gz_sz/map_3/red
