...
#Point_2
execute as @a[x=-6,y=23,z=-120,dx=-1,dz=-2] at @s unless score point_2 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_2
execute as @a[x=-6,y=23,z=-120,dx=-1,dz=-2] at @s if score point_2 Point_m1 matches 0..200 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=-6,y=23,z=-120,dx=-1,dz=-2] at @s if score point_2 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_3
execute as @a[x=-6,y=25,z=-133,dx=-2,dz=-4,dy=-1] at @s unless score point_3 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_3
execute as @a[x=-6,y=25,z=-133,dx=-2,dz=-4,dy=-1] at @s if score point_3 Point_m1 matches 0..160 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=-6,y=25,z=-133,dx=-2,dz=-4,dy=-1] at @s if score point_3 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_4
execute as @a[x=-6,y=25,z=-152,dx=-2,dz=-4] at @s unless score point_4 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_4
execute as @a[x=-6,y=25,z=-152,dx=-2,dz=-4] at @s if score point_4 Point_m1 matches 0..250 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=-6,y=25,z=-152,dx=-2,dz=-4] at @s if score point_4 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_5
execute as @a[x=-6,y=25,z=-168,dx=-2,dz=-4] at @s unless score point_5 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_5
execute as @a[x=-6,y=25,z=-168,dx=-2,dz=-4] at @s if score point_5 Point_m1 matches 0..150 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=-6,y=25,z=-168,dx=-2,dz=-4] at @s if score point_5 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_6
execute as @a[x=32,y=25,z=-173,dx=1,dz=3] at @s unless score point_6 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_6
execute as @a[x=32,y=25,z=-173,dx=1,dz=3] at @s if score point_6 Point_m1 matches 0..150 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=32,y=25,z=-173,dx=1,dz=3] at @s if score point_6 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_7
execute as @a[x=33,y=25,z=-153,dx=2,dz=3] at @s unless score point_7 Point_m1 matches -220.. run function co_light_dr:gz_sz/map_1/green/mp_7
execute as @a[x=33,y=25,z=-153,dx=2,dz=3] at @s if score point_7 Point_m1 matches 0..120 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=33,y=25,z=-153,dx=2,dz=3] at @s if score point_7 Point_m1 matches -220..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_8
execute as @a[x=33,y=24,z=-135,dx=2,dz=3] at @s unless score point_8 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_8
execute as @a[x=33,y=24,z=-135,dx=2,dz=3] at @s if score point_8 Point_m1 matches 0..180 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=33,y=24,z=-135,dx=2,dz=3] at @s if score point_8 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_9
execute as @a[x=33,y=31,z=-118,dx=2,dz=4] at @s unless score point_9 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_9
execute as @a[x=33,y=31,z=-118,dx=2,dz=4] at @s if score point_9 Point_m1 matches 0..180 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=33,y=31,z=-118,dx=2,dz=4] at @s if score point_9 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_10
execute as @a[x=33,y=24,z=-96,dx=2,dz=3] at @s unless score point_10 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_10
execute as @a[x=33,y=24,z=-96,dx=2,dz=3] at @s if score point_10 Point_m1 matches 0..150 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=33,y=24,z=-96,dx=2,dz=3] at @s if score point_10 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_11
execute as @a[x=53,y=23,z=-88,dx=2,dz=4] at @s unless score point_11 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_11
execute as @a[x=53,y=23,z=-88,dx=2,dz=4] at @s if score point_11 Point_m1 matches 0..80 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=53,y=23,z=-88,dx=2,dz=4] at @s if score point_11 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_12
execute as @a[x=57,y=23,z=-112,dx=2,dz=3] at @s unless score point_12 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_12
execute as @a[x=57,y=23,z=-112,dx=2,dz=3] at @s if score point_12 Point_m1 matches 0..90 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=57,y=23,z=-112,dx=2,dz=3] at @s if score point_12 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_13
execute as @a[x=56,y=23,z=-131,dx=2,dz=3] at @s unless score point_13 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_13
execute as @a[x=56,y=23,z=-131,dx=2,dz=3] at @s if score point_13 Point_m1 matches 0..135 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=56,y=23,z=-131,dx=2,dz=3] at @s if score point_13 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_14
execute as @a[x=58,y=23,z=-147,dx=1,dz=2] at @s unless score point_14 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_14
execute as @a[x=58,y=23,z=-147,dx=1,dz=2] at @s if score point_14 Point_m1 matches 0..150 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=58,y=23,z=-147,dx=1,dz=2] at @s if score point_14 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_15
execute as @a[x=76,y=29,z=-168,dx=3,dz=1] at @s unless score point_15 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_15
execute as @a[x=76,y=29,z=-168,dx=3,dz=1] at @s if score point_15 Point_m1 matches 0..180 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=76,y=29,z=-168,dx=3,dz=1] at @s if score point_15 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_16
execute as @a[x=103,y=29,z=-169,dx=3,dz=2] at @s unless score point_16 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_16
execute as @a[x=103,y=29,z=-169,dx=3,dz=2] at @s if score point_16 Point_m1 matches 0..150 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=103,y=29,z=-169,dx=3,dz=2] at @s if score point_16 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_17
execute as @a[x=120,y=29,z=-167,dx=8,dz=6] at @s unless score point_17 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_17
execute as @a[x=120,y=29,z=-167,dx=8,dz=6] at @s if score point_17 Point_m1 matches 0..150 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=120,y=29,z=-167,dx=8,dz=6] at @s if score point_17 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_18
execute as @a[x=130,y=29,z=-148,dx=2,dz=3] at @s unless score point_18 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_18
execute as @a[x=130,y=29,z=-148,dx=2,dz=3] at @s if score point_18 Point_m1 matches 0..150 run function co_light_dr:gz_sz/map_1/red
execute as @a[x=130,y=29,z=-148,dx=2,dz=3] at @s if score point_18 Point_m1 matches -140..-1 run function co_light_dr:gz_sz/map_1/yellow
#Point_19
execute as @a[x=132,y=23,z=-123,dx=2,dz=5] at @s unless score point_19 Point_m1 matches -140.. run function co_light_dr:gz_sz/map_1/green/mp_19
execute as @a[x=132,y=23,z=-123,dx=2,dz=5] at @s if score point_19 Point_m1 matches 0..150 run function co_light_dr:gz_sz/map_1/red
