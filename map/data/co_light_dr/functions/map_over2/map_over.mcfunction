...
execute as @a[x=-62,y=23,z=124,dx=1,dz=1,dy=1,tag=!finish,tag=player,team=!killer,gamemode=!creative,gamemode=!spectator] at @s run function co_light_dr:map_over2/map_over_3
