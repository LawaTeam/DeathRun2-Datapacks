...
execute if score 游戏模式 setting matches 1 run data modify block 45 38 1060 Text2 set value '{"text":"red","color":"gold","bold":"true"}'
...
execute if score 游戏模式 setting matches 2 run data modify block 45 38 1060 Text1 set value '{"text":"计时模式","color":"red","bold":"true"}'
execute if score 游戏模式 setting matches 2 run data modify block 45 38 1060 Text2 set value '{"text":"查看推荐设置的时间","color":"yellow","bold":"true","clickEvent":{"action":"run_command","value":"/function co_light_dr:recommend"}}'
