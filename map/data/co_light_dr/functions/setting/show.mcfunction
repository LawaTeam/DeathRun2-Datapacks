...
execute if score 游戏模式 setting matches 1 run data modify block 45 39 1056 Text2 set value '{"text":"-1","bold":"true","color":"yellow","clickEvent":{"action":"run_command","value":"/function co_light_dr:hearts_setting/remove_heart"}}'
execute if score 游戏模式 setting matches 1 run data modify block 45 39 1058 Text2 set value '{"text":"+1","bold":"true","color":"yellow","clickEvent":{"action":"run_command","value":"/function co_light_dr:hearts_setting/add_heart"}}'
