...
scoreboard players set map_1 map_start_timer 230
#传送分配玩家
#runner
spreadplayers 6.00 -79.77 2 4 true @a[team=runner]
spreadplayers 6.00 -79.77 2 4 true @a[team=spectator]
#killer
tp @a[team=killer] -7.27 23.48 -80.00
#清空玩家物品
clear @a
#清除玩家药水效果
effect clear @a
