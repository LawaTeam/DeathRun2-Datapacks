...
#副标题显示
execute if score map_1 map_start_timer matches 225 run title @a subtitle [{"text":"C i t y","color":"blue","bold":true,"underlined":true},{"text":" & ","color":"white"},{"text":"n a t u r e","color":"green","bold":true,"underlined":true}]
