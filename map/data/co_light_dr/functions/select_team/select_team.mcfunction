...
execute as @a[x=-25,y=32,z=1059,dx=1,dy=1,dz=1,team=!runner] at @s run tellraw @s [{"text":"[系统] ","color":"gold","bold": true},{"text":"你已成功","color":"white","bold": true},{"text": "加入","color": "dark_green","bold": true},{"text":"求生者","color":"aqua","bold": true},{"text":"队伍.","color":"white","bold": true}]
execute as @a[x=-25,y=32,z=1054,dx=1,dy=1,dz=1,team=!killer] at @s run tellraw @s [{"text":"[系统] ","color":"gold","bold": true},{"text":"你已成功","color":"white","bold": true},{"text": "加入","color": "dark_green","bold": true},{"text":"杀手","color":"red","bold": true},{"text":"队伍.","color":"white","bold": true}]
