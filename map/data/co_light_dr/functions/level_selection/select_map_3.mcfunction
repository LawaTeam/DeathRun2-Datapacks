...
summon minecraft:armor_stand 2.48 26.40 1012.52 {CustomName:'[{"text":"snow","color":"aqua","bold":true},{"text":" & ","color":"white"},{"text":"cave","color":"gray","bold":true}]',CustomNameVisible:true,Invisible:true,Marker:true,Tags:[select_map_3]}
