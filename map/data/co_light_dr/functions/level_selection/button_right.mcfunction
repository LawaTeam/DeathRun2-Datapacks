...
execute if score map map_selection matches 1 run function suxuan_dr:show_map/reset
execute if score map map_selection matches 1 run scoreboard players set map map_selection -2

#map=2
execute if score map map_selection matches 2 run scoreboard players reset map2 animate_time
execute if score map map_selection matches 2 run function suxuan_dr:show_map/reset
...
execute if score map map_selection matches 3 run function suxuan_dr:show_map/reset
