...
execute if score map3 animate_time matches 75 run setblock 1 28 1005 stone
...
execute positioned 2 27.5 1005 if score map3 animate_time matches 120 run function suxuan_dr:show_map/reset
