...
execute if score second_check animate_time matches 2 run fill -270 56 714 -266 54 714 white_concrete
...
execute if score second_check animate_time matches 4 if score summon_author animate_time matches 0 run fill -270 56 714 -266 54 714 gray_concrete
