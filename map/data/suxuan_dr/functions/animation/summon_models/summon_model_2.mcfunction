...
summon minecraft:armor_stand -255.5 55.00 728.5 {CustomName:'[{"text":"[Killer]","bold":true,"color":"red"},{"text":"在机关触发点可以获得机关开关","bold": true,"color": "gold"}]',CustomNameVisible:1b,NoGravity:1b,Tags:["text2"],Invisible:1b}

summon minecraft:armor_stand -255.5 54.75 728.5 {CustomName:'[{"text":"右键","bold":true,"color":"dark_aqua"},{"text":"即可开启开关","bold": true,"color":"gold"}]',CustomNameVisible:1b,NoGravity:1b,Tags:["text2"],Invisible:1b}

summon minecraft:armor_stand -255.5 54.50 728.5 {CustomName:'[{"text":"机关触发后会进入冷却(","bold":true,"color":"gold"},{"text":"红","bold": true,"color":"red"},{"text":",","bold": true,"color":"gold"},{"text":"黄","bold": true,"color":"yellow"},{"text":")","bold": true,"color":"gold"}]',CustomNameVisible:1b,NoGravity:1b,Tags:["text2"],Invisible:1b}

summon minecraft:armor_stand -255.5 54.25 728.5 {CustomName:'[{"text":"合理利用机关以阻碍求生者的步伐！","bold":true,"color":"green"}]',CustomNameVisible:1b,NoGravity:1b,Tags:["text2"],Invisible:1b}