...
execute if score lalamei lalamei matches 140 run tellraw @a[x=2,y=18,z=1036,dx=6,dy=3,dz=4] [{"text":"<拉拉妹> ","color":"aqua"},{"text":"回到正题!","color":"aqua","bold":true}]
