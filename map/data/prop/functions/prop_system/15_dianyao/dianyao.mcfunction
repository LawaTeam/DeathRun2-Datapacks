...
execute if score @s prop_temp matches 2..5 run replaceitem entity @a[team=killer] hotbar.1 green_dye{display:{Name:'{"text": "一小儿","bold":true,"color":"gray","italic":false}'}}
execute if score @s prop_temp matches 6..9 run replaceitem entity @a[team=killer] hotbar.2 brown_dye{display:{Name:'{"text": "另一小儿","bold":true,"color":"gray","italic":false}'}}
execute if score @s prop_temp matches 10 run replaceitem entity @a[team=killer] hotbar.1 green_dye{display:{Name:'{"text": "一小儿","bold":true,"color":"gray","italic":false}'}}
execute if score @s prop_temp matches 10 run replaceitem entity @a[team=killer] hotbar.2 brown_dye{display:{Name:'{"text": "另一小儿","bold":true,"color":"gray","italic":false}'}}
