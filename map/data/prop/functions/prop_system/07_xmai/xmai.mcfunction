...
tellraw @a[tag=!use_xmai] [{"text": "[系统] ","bold": true,"color":"gold"},{"selector":"@s","bold": true,"color": "aqua"},{"text": "使用了神签 [","bold": true,"color":"gold"},{"text": "x迈","bold": true, "color":"green"},{"text": "] ","bold": true,"color":"gold"}]
