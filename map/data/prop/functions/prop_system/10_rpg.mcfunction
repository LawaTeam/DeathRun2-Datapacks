...
execute as @a[team=killer,nbt={Inventory:[{Slot:-106b,id:"minecraft:stick",tag:{CustomModelData:1010}}]}] at @s run tellraw @a[team=runner] {"text": "RPG!!!注意分散!!!","color": "red","bold": true}
