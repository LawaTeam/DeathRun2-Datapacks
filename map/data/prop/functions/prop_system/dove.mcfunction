...
# @LastEditTime: 2023-03-11 16:17:12
# @Description: 
#--------------------------------------------------

# 德芙
# 检测是否使用
execute as @a[team=killer,tag=!use_crowbar] if data entity @s Inventory[{Slot:-106b,id:"minecraft:stick",tag:{CustomModelData:1003}}] run tag @s add use_dove
