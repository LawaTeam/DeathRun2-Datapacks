...
function prop:prop_system/0_box_check/check
...
execute if entity @s[tag=item_0] run loot replace entity @s hotbar.1 loot prop:blind_box
execute if entity @s[tag=item_0] run loot replace entity @s hotbar.2 loot prop:blind_box
