...
tellraw @a [{"text": "[系统] ","bold": true,"color":"gold"},{"selector":"@s","bold": true,"color": "red"},{"text": "使用了道具 [","bold": true,"color":"gold"},{"text": "重锤来咯","bold": true, "color":"yellow"},{"text": "] ","bold": true,"color":"gold"},{"text": "小心头顶!","bold": true,"color": "red"}]
