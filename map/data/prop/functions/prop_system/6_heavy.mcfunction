...
execute if entity @a[tag=use_heavy] if score heavy prop_time matches 100 run tag @a[team=runner] add heavy
...
# 提示
execute if score heavy prop_time matches ..150 run title @a[team=runner] actionbar {"text": "小心头上！","bold": true,"color": "red"}
