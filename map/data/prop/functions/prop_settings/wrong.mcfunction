...
execute positioned 23 39 1060 if score second prop_settings matches ..9 run tellraw @a[distance=..7] [{"text": "[系统] ","bold": true,"color":"gold"},{"text": "获取道具时间间隔不可以低于10秒","bold": true,"color": "red"}]
...
execute positioned 23 39 1060 if score second prop_settings matches 101.. run tellraw @a[distance=..7] [{"text": "[系统] ","bold": true,"color":"gold"},{"text": "获取道具时间间隔不可以高于100秒","bold": true,"color": "red"}]
