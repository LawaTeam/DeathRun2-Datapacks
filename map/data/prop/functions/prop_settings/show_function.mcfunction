...
execute if entity @s[nbt={SelectedItem:{tag:{CustomModelData:1009}}},team=runner] run title @s actionbar {"text": "杀手定身1秒","bold": true,"color": "gold"}
...
execute if entity @s[nbt={SelectedItem:{tag:{CustomModelData:1011}}}] run title @s actionbar {"text": "给予杀手反胃5秒","bold": true,"color": "gold"}
