...
data merge block 27 38 1062 {Color:"black",Text4:'{"text":""}',Text3:'{"text":""}',Text2:'{"bold":true,"color":"white","extra":[{"bold":true,"color":"green","text":"加入道具"}],"text":"当前:"}',Text1:'{"bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/function prop:prop_settings/off"},"text":"右键取消道具"}'}
setblock 27 38 1063 green_concrete
scoreboard players set 开关 prop_settings 1
team modify daoju suffix {"text": " 是","bold": true, "color": "gold"}
...
summon armor_stand 24.3 39.8 1060.5 {CustomName:'{"text": "设置获取道具时间间隔","bold": true,"color": "gold"}',Tags:["interval"],Marker:1b,CustomNameVisible:1b,NoGravity:1b,Invisible:1b}
